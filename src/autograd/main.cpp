...
class LinearFunction : public Function<LinearFunction> {
    public:
    // Both forward and backward are static functions
    ...
    static tensor_list backward(AutogradContext *ctx, tensor_list grad_outputs) {
        ...
        // Calculate the gradient bias, If it's defined
        if (bias.defined()) {
...
void custom_autograd_function() {
    std::cout << "====== Using Custom Autograd function in C++ ======" << std::endl;
